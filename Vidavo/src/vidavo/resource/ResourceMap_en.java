...
public class ResourceMap_en extends java.util.ListResourceBundle {
    ...
    protected Object[][] getContents() {
        return new Object [][] {
                ...
                {"sugarUsageMRadioButton.text","Much"},
                {"saltUsageLRadioButton.text","Little"},
                {"saltUsageNRadioButton.text","None"},
                {"sugarUsageLabel.text","Sugar Usage :"},
                {"saltUsageMRadioButton.text","Much"},
                {"sugarUsageLRadioButton.text","Little"},
                {"sugarUsageNRadioButton.text","None"},
                {"dietLabel.text","Diet"},
